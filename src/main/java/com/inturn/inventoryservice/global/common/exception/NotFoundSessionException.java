...
public final class NotFoundSessionException extends BaseException {

	public NotFoundSessionException() {
		super(CommonErrorCode.NOT_FOUND_SESSION_EXCEPTION.getHttpStatus(), CommonErrorCode.NOT_FOUND_SESSION_EXCEPTION.getErrorMessage());
	}
